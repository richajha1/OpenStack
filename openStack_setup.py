...
def _create_keystone_users():
    ...
    write_to_file(adminrc, "export OS_PASSWORD=admin\n")
...
print_format(" Installation successfull! Login into horizon http://%s/horizon  Username:admin  Password:admin " % ip_address)
